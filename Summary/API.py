...
# клиента и сервера. Для тестирования в качестве клиента я использую Postman. од термином гипертекст следует
...
#по какой-нибудь ссылке в этой статье, то вероятнее всего к запросу будет добавлен заголовок Refer: https://selectel.ru
Accept
